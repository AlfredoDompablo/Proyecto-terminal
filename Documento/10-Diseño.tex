...
\begin{figure}[H]
    \centering
    % Asegúrate de guardar el diagrama de la red WSN como 'uc_wsn.pdf' o '.png'
...
\begin{figure}[H]
    \centering
    % Asegúrate de guardar el diagrama del servidor como 'uc_backend.pdf' o '.png'
...
\begin{figure}[H]
    \centering
    % Asegúrate de guardar el diagrama web como 'uc_webapp.pdf' o '.png'
    \includegraphics[width=0.9\linewidth]{Documento/Imagenes/Diseño/UML/aplicacionWeb.pdf}
