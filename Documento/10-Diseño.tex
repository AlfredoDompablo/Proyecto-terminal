...
El diagrama de arquitectura presentado describe la organización y los componentes principales del sistema de monitoreo ambiental basado en una Red Inalámbrica de Sensores (WSN). El sistema se compone de tres bloques principales: la Red Inalámbrica de Sensores, el Servidor en la Nube, y la Visualización Web.

\textbf{Red Inalámbrica de Sensores (WSN)}
Este bloque incluye los Nodos Sensores y el Nodo Concentrador(Gateway). Los nodos sensores, equipados con el microcontrolador Heltec ESP32, los sensores (pH, oxígeno disuelto, turbidez, etc.), y la cámara, están interconectados mediante el protocolo de comunicación LoRa. Los nodos sensores capturan datos de las condiciones del agua y los envían al Nodo Concentrador a través de LoRa.
...
Este diagrama destaca las interacciones entre los componentes del sistema, incluyendo la transmisión de datos desde los nodos sensores a través del nodo concentrador, el procesamiento y almacenamiento en la nube, y la entrega de resultados al usuario final a través de la aplicación web.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{Documento/Imagenes/Diseño/Diagramadearq.pdf}
