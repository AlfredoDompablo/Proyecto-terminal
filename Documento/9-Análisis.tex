...
\textbf{Módulo/Chip} & Heltec (SX1262) \cite{semtech_sx1261_2017} & Quectel FGH100M & ESP32-S3 \cite{EspressifESP32S3} & XBee S2C \cite{DigiXBeeS2C} & HC-05 \cite{HC05Datasheet} \\ \hline
...
\label{subsec:justificacion_estrategia}
...
No obstante, la limitación crítica de LoRa es su ancho de banda, lo que dificulta la transmisión de archivos grandes como imágenes (\SI{\sim 150}{\kilo\byte}). El cálculo del Tiempo en el Aire (ToA) para una imagen fragmentada, asumiendo una configuración optimista (SF7, BW \SI{500}{\kilo\hertz}), ilustra este desafío:

\[
\text{ToA} \approx \frac{\text{Tamaño Imagen (\SI{1.23}{Mbits})}}{\text{Tasa de Datos (\SI{21.9}{kbps})}} \approx \textbf{\SI{56}{segundos}}
\]
