...
\textbf{Modo Operativo}&\multicolumn{2}{c}{\shortstack[c]{\textbf{Componentes}\\\textbf{activos}}}& \textbf{Corriente Total} & \textbf{Tiempo Semanal} & \textbf{Energía Semanal} \\
 &\multicolumn{2}{c}{(mA)}& {(\unit{\milli\ampere})} & {(\unit{\hour})} & {(\unit{\milli\ampere\hour})} \\
\midrule
...
El consumo energético total estimado para el nodo más exigente es de aproximadamente \SI{25.921}{\milli\ampere\hour} por semana. Este valor extremadamente bajo confirma que la estrategia de baja frecuencia de muestreo es altamente efectiva para la conservación de energía. 
